...
// wyc modify
PAGEFLAG(DropPage, droppage, PF_ANY)
	__CLEARPAGEFLAG(DropPage, droppage, PF_ANY)
	__SETPAGEFLAG(DropPage, droppage, PF_ANY)
	TESTCLEARFLAG(DropPage, droppage, PF_ANY)

// wyc modify
PAGEFLAG(OldPage, oldpage, PF_ANY)
	__CLEARPAGEFLAG(OldPage, oldpage, PF_ANY)
	__SETPAGEFLAG(OldPage, oldpage, PF_ANY)
	TESTCLEARFLAG(OldPage, oldpage, PF_ANY)

// wyc modify
PAGEFLAG(SysPage, syspage, PF_ANY)
__CLEARPAGEFLAG(SysPage, syspage, PF_ANY)
__SETPAGEFLAG(SysPage, syspage, PF_ANY)
TESTCLEARFLAG(SysPage, syspage, PF_ANY)

// wyc modify
PAGEFLAG(UserPage, userpage, PF_ANY)
__CLEARPAGEFLAG(UserPage, userpage, PF_ANY)
__SETPAGEFLAG(UserPage, userpage, PF_ANY)
TESTCLEARFLAG(UserPage, userpage, PF_ANY)
#ifdef CONFIG_MMU
