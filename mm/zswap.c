...
static unsigned int zswap_accept_thr_percent = 100; /* of max pool size */
...
#define max_virt_page_capacity 3*1024*1024/4
static int zswap_virt_page_capacity = max_virt_page_capacity;
module_param_named(virt_page_capacity, zswap_virt_page_capacity,
		   int, 0644);
...
{
	int zswap_virt_stored_pages = atomic_read(&zswap_stored_pages);
	return zswap_virt_page_capacity <= zswap_virt_stored_pages;
